...
export function LeadsPage() {
  ...
  if (isValidating) {
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-6 text-center pt-[120px] max-md:pt-[96px]">
  ...
  return (
    <div className="min-h-screen bg-[#F5F7FA] pb-16 pt-[120px] max-md:pt-[96px]">
